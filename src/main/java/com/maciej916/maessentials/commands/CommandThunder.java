...
public class CommandThunder {
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        LiteralArgumentBuilder<CommandSource> builder = Commands.literal("thunder").requires(Utils.hasPermission(PermissionStrings.COMMAND.THUNDER));
    ...
    private static int rain(CommandContext<CommandSource> context) throws CommandSyntaxException {
        ...
        player.sendMessage(Utils.translateFromJson("thunder.maessentials.success"));
