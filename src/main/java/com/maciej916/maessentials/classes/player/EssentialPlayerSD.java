...
import static com.maciej916.maessentials.libs.Json.getJsonElement;
import static com.maciej916.maessentials.libs.Json.getJsonObject;
...
public class EssentialPlayerSD implements JsonDeserializer<EssentialPlayer>, JsonSerializer<EssentialPlayer> {
    ...
    public EssentialPlayer deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        boolean needingSpawnMove = new Gson().fromJson(object.get("needingSpawnMove"), Boolean.class);
        ...
        EssentialPlayer eslPlayer = new EssentialPlayer(uuid, username, needingSpawnMove, data, restrictions, last_usage, custom_data);
        return eslPlayer;
    }
    ...
    public JsonElement serialize(EssentialPlayer src, Type typeOfSrc, JsonSerializationContext context) {
        ...
        object.add("needingSpawnMove", getJsonElement(src.isNeedingSpawnMove()));
